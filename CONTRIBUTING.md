...
* **Angular and Md2 Versions** - which versions of Angular and Md2 are affected
    (e.g. 2.0.0-alpha.53)
...
You can file new issues by providing the above information [here](https://github.com/dharmeshpipariya/md2/issues/new).


### <a name="submit-pr"></a> Submitting a Pull Request (PR)
Before you submit your Pull Request (PR) consider the following guidelines:

* Search [GitHub](https://github.com/dharmeshpipariya/md2/pulls) for an open or closed PR
...
[github]: https://github.com/dharmeshpipariya/md2
