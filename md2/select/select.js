...
(function (factory) {
    if (typeof module === 'object' && typeof module.exports === 'object') {
        ...
        define(["require", "exports", '@angular/core', '@angular/forms', '@angular/common', '../core/core'], factory);
    }
            ...
            if (this.isMenuVisible) {
                ...
                switch (event.keyCode) {
                    ...
                    case core_2.KeyCodes.SPACE:
                        this._options.toArray()[this.focusIndex].onClick(event);
                        break;
