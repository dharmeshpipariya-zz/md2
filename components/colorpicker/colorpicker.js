...
const colorpicker_service_1 = require('./colorpicker.service');
let Md2Colorpicker = class Md2Colorpicker {
    constructor(dcl, vcRef, el, service) {
        this.dcl = dcl;
        this.vcRef = vcRef;
        this.el = el;
...
], Md2Colorpicker.prototype, "colorpicker", void 0);
__decorate([
    core_1.Input('position'), 
    __metadata('design:type', String)
], Md2Colorpicker.prototype, "cPosition", void 0);
__decorate([
    core_1.Input('offset'), 
    __metadata('design:type', String)
], Md2Colorpicker.prototype, "offset", void 0);
__decorate([
    core_1.Input('format'), 
    __metadata('design:type', String)
...
Md2Colorpicker = __decorate([
    ...
    __metadata('design:paramtypes', [core_1.DynamicComponentLoader, core_1.ViewContainerRef, core_1.ElementRef, colorpicker_service_1.Md2ColorpickerService])
], Md2Colorpicker);
...
let ColorpickerComponent = class ColorpickerComponent {
    constructor(el, service) {
        this.el = el;
        this.service = service;
        this.actualHeight = 240;
        this.actualWidth = 220;
    }
    setColorpickerDialog(instance, elementRef, color, cPosition, offset, cFormat) {
...
var colorpicker_service_2 = require('./colorpicker.service');
exports.Md2ColorpickerService = colorpicker_service_2.Md2ColorpickerService;
