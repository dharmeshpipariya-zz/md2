...
Md2Colorpicker = __decorate([
    ...
    __metadata('design:paramtypes', [core_1.DynamicComponentLoader, core_1.ViewContainerRef, core_1.ElementRef, colorpicker_service_1.ColorpickerService])
], Md2Colorpicker);
...
let ColorpickerComponent = class ColorpickerComponent {
    constructor(el, service) {
        this.el = el;
        this.service = service;
        this.actualHeight = 220;
        this.actualWidth = 220;
    }
    setColorpickerDialog(instance, elementRef, color, cPosition, offset, format) {
...
ColorpickerComponent = __decorate([
  ...
  `],
    ...
    __metadata('design:paramtypes', [core_1.ElementRef, colorpicker_service_1.ColorpickerService])
