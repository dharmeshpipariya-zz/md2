...
var multiselect_item_1 = require('./multiselect-item');
var multiselect_pipes_1 = require('./multiselect-pipes');
...
var Select = (function () {
    ...
    Object.defineProperty(Select.prototype, "items", {
        set: function (value) {
            this._items = value;
            this.itemObjects = this._items.map(function (item) { return new multiselect_item_1.SelectItem(item); });
        },
        enumerable: true,
        configurable: true
    });
    ...
    Select.prototype.ngOnInit = function () {
        ...
        if (this.initItem) {
            this.active = this.initItem.map(function (d) { return new multiselect_item_1.SelectItem(d); });
    ...
    Select = __decorate([
        core_1.Component({
            selector: 'md2-select',
            pipes: [multiselect_pipes_1.HightlightPipe],
